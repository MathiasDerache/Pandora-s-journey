    ...
    <nav class="container-fluid fixed-top">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-9 col-xl-9 listnav">
                <ul>
                    <li><a href="liste_annonces_controleur.php?action=annonces_immobilier" class="nav-link text-white">Immobilier</a></li>
                    <li><a href="liste_annonces_controleur.php?action=annonces_travail" action="annonces_travail" class="nav-link text-white">Travail</a></li>
                    <li><a href="liste_annonces_controleur.php?action=annonces_loisir" action="annonces_loisir" class="nav-link text-white">Loisir</a></li>
