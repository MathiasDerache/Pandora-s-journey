...
function SujetThemeForum(SujetTheme $sujetTheme)
{
?>
    <!DOCTYPE html>
    <html lang="fr">
                ...
                <div class="col-sm-8 col-md-8 col-lg-10 col-xl-10 text-white sujetThForum mb-5 mt-5">
                    <div class="row justify-content-center mt-5">
                        <div class="title-forum text-white mb-5">
                            <h1>Questions sur la thématique: <?php echo $sujetTheme->getTypeSujetTh(); ?></h1>
                        </div>
                    </div>
                        ...
                        <div class="media ml-5 pt-5">
                            ...
                            <div class="media-body mt-5">
                                <h5 class="mt-0 ">Auteur : <?php
                                                            ...
                                                            ?>
                                    <span class="bg-danger border border-dark p-2 shadow rounded-pill"><?php echo $pseudo->getPseudo(); ?></span><?php
                                                                                                                                                    ?></h5>
                                <h3 class="mt-3">
                                    <?php echo $sujetTheme->getQuestionSujet(); ?>
                                </h3>
                                <p class="mb-0">Publié le <?php echo $sujetTheme->getDateAjout()->format("d-m-Y"); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
